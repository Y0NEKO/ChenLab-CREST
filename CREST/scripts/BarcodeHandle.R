...
# filename = "/picb/sysgenomics2/people/liuhengxin/P6_lineartree/myscript/CRESTLineage/test_data/samplesheet.txt"

FindScar = function(mycrest, cln = 10){
